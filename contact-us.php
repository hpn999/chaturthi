                        ...
                        <div class="flex-column">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" value="<?php echo $show['fullname']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="exampleFormControlInput3" value="<?php echo $show['mobile']; ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="mapouter pt-3">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3786.078377473719!2d74.55922071457587!3d18.38928367797639!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc312eef31e23e5%3A0xaf802d2f1a9f86ff!2sChaturthi%20Veg!5e0!3m2!1sen!2sus!4v1671006217006!5m2!1sen!2sus" width="690" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
