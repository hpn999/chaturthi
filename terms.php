...
<body class="fixed-bottom-bar">
    ...
    <div class="osahan-profile">
                    ...
                    <div class="rounded shadow-sm">
                        <div class="osahan-privacy bg-white rounded shadow-sm p-4">
                            <div id="intro" class="mb-4">
                                <!-- Title -->
                                <div class="mb-3">
                                    <h2 class="h5">Welcome to चतुर्थी-व्हेज</h2>
                                </div>
                                <!-- End Title -->
        ...
        <div class="osahan-menu-fotter fixed-bottom bg-white px-3 py-2 text-center d-none">
            <div class="row">
                <div class="col">
                    <a href="home.php" class="text-dark small font-weight-bold text-decoration-none">
                        <p class="h4 m-0"><i class="feather-home text-dark"></i></p>
                        Home
                    </a>
                </div>
                <div class="col">
                    <a href="most_popular.php" class="text-dark small font-weight-bold text-decoration-none">
                ...
                <div class="col">
                    <a href="favorites.php" class="text-dark small font-weight-bold text-decoration-none">
                        <p class="h4 m-0"><i class="feather-heart"></i></p>
                        Favorites
                    </a>
                </div>
                <div class="col selected">
                    <a href="profile.php" class="text-success small font-weight-bold text-decoration-none">
