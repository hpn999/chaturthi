        ...
        <div class="container">
            <div class="most_popular py-5">
                <div class="d-flex align-items-center mb-4">
                    <h3 class="font-weight-bold text-dark mb-0">China Town Se Starter</h3>
                ...
                <div class="row">
                    ...
                    $query_show = mysqli_query($conn, "SELECT * FROM products WHERE productCat = 'China Town Se Starter'");
