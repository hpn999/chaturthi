...
<body class="fixed-bottom-bar">
                                    ...
                                    <div class="">
                                        ...
                                        ?>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="product-price"><?php echo $price; ?></div><input class="product-price" type="hidden" value="<?php echo $price; ?>">
                                                    <div class="product-quantity">
                                                        <input class="product-quantity" type="number" name="quantity" value="2" maxlength="2" max="10" size="1" id="number" />
                                                    </div>
                                                    <div class="product-removal">
                                                        <a class="remove-product" href="remove_cart.php?id=<?php echo $row['id']; ?>">
                                                            Remove </a>
                                                    </div>
                                                    <div class="product-line-price" name="total"></div>
                                                </div>
                                                ...
                                                <div class="bg-white p-3 clearfix border-bottom">
                                                    ...
                                                    <div class="totals">
                                                        <div class="totals-item">
                                                            ...
                                                            <div class="totals-value" id="cart-subtotal">69.00</div>
                                                        </div>
                                                        <div class="totals-item">
                                                            <label>Tax (5%)</label>
                                                            <div class="totals-value" id="cart-tax">3.45</div>
                                                        </div>
                                                        <div class="totals-item totals-item-total">
                                                            <label>Grand Total</label>
                                                            <div class="totals-value" id="cart-total">72.45</div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        var product_quantity = document.getElementsByClassName('product-quantity');
        var product_line_price = document.getElementsByClassName('product-line-price');

        function subTotal() {
            if (product_price && product_quantity) {
                for (i = 0; i < product_price.length; i++) {
                    product_line_price[i].innerText = (product_price[i].value) * (product_quantity[i].value);
                }
            }
        }
